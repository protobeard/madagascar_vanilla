...
namespace MadagascarVanilla.Patches
{
    ...
    {
        private const string EnableAutoCutKey = "enableAutoCut";
        ...
        {
            bool enableAutoCut = bool.Parse(SettingsManager.GetSetting(MadagascarVanillaMod.ModId, EnableAutoCutKey));
